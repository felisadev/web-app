...
const a1 = CardData("Si te encuentras en situación de violencia, no olvides tener a mano lo siguiente:",
  `
...
const a2 = CardData("Si has puesto denuncia y tener contacto con el agresor es un peligro:",
  `
         · Cambia de número de celular
         · Bloquea al agresor de tus redes sociales.
         `,)

const a3 = CardData("Si acabas de sufrir violencia:",
...
const a4 = CardData("Si acabas de sufrir violencia sexual, recuerda:",
...
const a5 = CardData("Es recomendable que puedas grabar audios o sacar fotografías de una situación de violencia, como pruebas para un futuro proceso", "")

const a6 = CardData("No dejes solos a tus hijos/as, pide el apoyo de una familiar o amiga para cuidarlos.", "")
const a7 = CardData("Si la familia de tu agresor te amenaza, golpea o insulta debes avisar a las autoridades que atienden tu caso.", "")
const a8 = CardData("Tener un grupo de amigas/os o familiares de confianza puede ayudar a prevenir una situación de violencia, ya que en ocasiones es difícil para la víctima darse cuenta que está sufriendo violencia. Las/os amigas/os y/o familiares pueden notar tus cambios de comportamiento y podrán alertarte a tiempo de la situación de violencia en la que te encuentras.", "")
const a9 = CardData("Las mujeres víctimas de violencia tienen características muy diferentes y pueden ser desde tus compañeras de trabajo hasta miembros de tu propia familia. No debemos esperar a que las personas encajen en nuestra idea de cómo se ve una víctima para escuchar y ayudar.", "")
    ...
    <Box display="flex" justifyContent="center">
      ...
      <Box maxWidth="lg" sx={{ paddingX: { xs: '2rem', md: '5rem' } }}>
        ...
        <Grid container direction="column">
          <Grid item width="240px" alignContent="center">
          </Grid>
          <Box
            marginTop={""}
            display="flex"
            ...
            alignItems="center"
          >
            <img src="felisa_walking_gimp.png" style={{ width: '50%', margin: 'auto' }} />
          </Box>
